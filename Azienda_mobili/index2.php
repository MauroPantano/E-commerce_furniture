          ...
          <div class="row">
            <div class="col-xs-12 col-sm-4">
              <div class="main-search mt_40">
                <input id="search-input" name="cerca" value="" placeholder="Cerca" class="form-control input-lg" autocomplete="off" type="text">
                <span class="input-group-btn">
              <button type="button" name="cercaBottone" class="btn btn-default btn-lg"><i class="fa fa-search"></i></button>
              </span> </div>
            </div>
        ...
        <div class="col-sm-12 mt_30">
          ...
          <div id="product-tab" class="mt_10">
            ...
            <div class="tab-content clearfix box">
              ...
              <!-- FINE PRODOTTI PIU VENDUTI  -->
              <!-- INIZIO PRODOTTI IN PRIMO PIANO -->
              <div class="tab-pane" id="Featured">
                <div class="Featured owl-carousel">
                  <!-- INIZIO PRODOTTO SINGOLO  -->
                  <?php
                  $query3 = "SELECT *
                            FROM MOBILE
                            ORDER BY CUORE DESC
